...
class Network():
    ...
    def num_kegg_gene_interaction(self):
        ...
        kegg_gene_annotation_df.to_csv('../datainfo/filtered_data/kegg_gene_num_dict.csv', index=False, header=True)
        kegg_gene_num_dict = dict(zip(kegg_gene_annotation_df.kegg_gene, kegg_gene_annotation_df.gene_num))
        kegg_gene_interaction_df = pd.read_csv('../datainfo/filtered_data/kegg_gene_interaction.csv')
        kegg_gene_interaction_df = kegg_gene_interaction_df.replace({'src': kegg_gene_num_dict, 'dest': kegg_gene_num_dict})
        kegg_gene_interaction_df.to_csv('../datainfo/filtered_data/kegg_gene_num_interaction.csv', index=False, header=True)
    ...
    def num_drugbank_interaction(self):
        ...
        drugbank_drug_annotation_df.to_csv('../datainfo/filtered_data/drug_num_dict.csv', index=False, header=True)
        ...
        final_drugbank_num_df.to_csv('../datainfo/filtered_data/final_drugbank_num.csv', index=False, header=True)
    
    def combine_network(self):
        kegg_gene_num_interaction_df = pd.read_csv('../datainfo/filtered_data/kegg_gene_num_interaction.csv')
        ...
        all_edge_num_df.to_csv('../datainfo/filtered_data/all_edge_num.csv', index=False, header=True)
